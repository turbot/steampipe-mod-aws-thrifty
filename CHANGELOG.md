...
- Fixed the inline query of the `secretsmanager_secret_unused` to correctly verify if a secret has remained unused for a specified duration. ([#138](https://github.com/turbot/steampipe-mod-aws-thrifty/pull/138))
