...
benchmark "cloudtrail" {
  ...
  description   = "Multiple active CloudTrail Trails can add signifigant costs. Be thrifty and eliminate the extra trails."
...
control "multiple_global_trails" {
  ...
  documentation = file("./controls/docs/cloudtrail-multi-global.md") #TODO
...
control "multiple_regional_trails" {
  ...
  documentation = file("./controls/docs/cloudtrail-multi-regional.md") #TODO
