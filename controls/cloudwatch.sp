...
benchmark "cloudwatch" {
  ...
  description   = "Thrifty developers activley manage the retention of their Cloudtrail logs."
...
control "cw_log_group_retention" {
  ...
  documentation = file("./controls/docs/cloudwatch-log-group-retention.md") #TODO
